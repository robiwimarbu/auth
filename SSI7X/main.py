...
from SSI7X.AuthUsers import CmboCntrsna,AutenticacionUsuarios,MenuDefectoUsuario,BusquedaImagenUsuario, ValidaToken
...
api.add_resource(ValidaToken,'/valida_token')
